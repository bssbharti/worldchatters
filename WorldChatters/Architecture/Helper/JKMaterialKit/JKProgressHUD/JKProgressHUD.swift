...
public class JKProgressHUD:UIView{
    ...
    fileprivate func addContentView(){
        ...
        guard let hudContentView = hudContentView else {
            return
        }
    ...
    fileprivate func addHudView(){
        ...
        if hudMode == .HorizontalBar
        {
            ...
            guard let barIndicator = barIndicator else{return}
        ...
        else if hudMode == .Determinate || hudMode == .AnnularDeterminate
        {
            ...
            guard let circularProgress = circularProgress else{return}
        ...
        else if hudMode == .GIF
        {
            ...
            guard let gifIndicatorView = gifIndicatorView else{return}
